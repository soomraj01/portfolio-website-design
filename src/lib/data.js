export const projects = [
  {
    ...
    tech: ['WordPress', 'Elementor', 'Elementor Pro', 'WPForms', 'Responsive Design'],
    ...
    gallery: ['/images/mrsolar-homepage.webp', '/images/mrsolar-services.webp'],
  },
  {
    slug: 'novaweb-agency',
    name: 'NovaWeb Agency',
    ...
    gallery: ['/images/novaweb-homepage.webp', '/images/novaweb-services.webp'],
  },
  {
    ...
    tech: ['WordPress', 'Elementor', 'Custom CSS', 'JavaScript', 'Responsive Design'],
    ...
    gallery: ['/images/defi100x-homepage.webp', '/images/defi100x-community.webp'],
  },
  {
    ...
    tech: ['React', 'Tailwind CSS', 'Responsive Design', 'JavaScript', 'Netlify'],
